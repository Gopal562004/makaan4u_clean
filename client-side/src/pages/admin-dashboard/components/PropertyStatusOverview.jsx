    ...
    <div className="bg-card border border-border rounded p-6 shadow-subtle">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {Object.entries(statusConfig).map(([status, config]) => (
          <div
            key={status}
            className="text-center p-3 bg-muted/30 rounded hover:shadow-md transition-all"
          >
            <div
      ...
      <div className="space-y-3 max-h-80 overflow-y-auto">
        {recentProperties.length === 0 ? (
          ...
          recentProperties.map((property) => (
            <div
              key={property._id}
              className="flex items-center justify-between p-3 border border-border rounded hover:bg-muted/30 transition-all"
            >
              {/* Left: Thumbnail + Info */}
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-8 w-36 bg-popover border border-border rounded shadow-moderate opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
